...
void STDCALL _cpuid(_cpuid_args *args);

UINT32 _read_cr0();
UINT32 _read_cr2();
UINT32 _read_cr3();
UINT32 _read_cr4();
void __stdcall _set_cr0(UINT32 _cr0);
void __stdcall _set_cr2(UINT32 _cr2);
void __stdcall _set_cr3(UINT32 _cr3);
void __stdcall _set_cr4(UINT32 _cr4);
...
#define MAKE_DESC_HIGH(base,limit,g,db,p,dpl,s,type) \
...
void __stdcall _lidt(DESC_PTR *idtptr);
void __stdcall _lldt(DESC_PTR *ldtptr);
void __stdcall _lgdt(DESC_PTR *gdtptr);
...
#define EFLAGS_CF       0x000000001 //Carry
#define EFLAGS_1        0x000000020 //Always Set to one
#define EFLAGS_PF       0x000000004 //Parity
#define EFLAGS_AF       0x000000010 //Auxiliary Carry
#define EFLAGS_ZF       0x000000040 //Zero
#define EFLAGS_SF       0x000000080 //Sign
#define EFLAGS_TF       0x000000100 //Trap
#define EFLAGS_IF       0x000000200 //Interrupt Enable
#define EFLAGS_DF       0x000000400 //Direction
#define EFLAGS_OF       0x000000800 //Overflow
#define EFLAGS_IOPL     0x000003000 //I/O Privilege Level
#define EFLAGS_NT       0x000004000 //Nested Task
#define EFLAGS_RF       0x000010000 //Resume
#define EFLAGS_VM       0x000020000 //Virtual-8086 Mode
#define EFLAGS_AC       0x000040000 //Alignment Check
#define EFLAGS_VIF      0x000080000 //Virtual Interrupt
#define EFLAGS_VIP      0x000100000 //Virtual Interrupt Pending
#define EFLAGS_ID       0x000200000 //CPUID
...
typedef struct _EXEPTION_STACK_E
{
...
typedef struct _EXEPTION_STACK
{
    UINT32 EDI,ESI,EBP,ESP,EBX,EDX,ECX,EAX;
    //UINT32 ErrorCode;
    UINT32 EIP,CS,EFLAGS;
