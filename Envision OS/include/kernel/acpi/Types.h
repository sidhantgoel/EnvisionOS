...
/*
 * MACHINE_WIDTH must be specified in an OS- or compiler-dependent header
 ...
 */
typedef struct _ACPI_OBJECT_LIST
{
    UINT32                          Count;
    ACPI_OBJECT                     *Pointer;
...
typedef struct _ACPI_OBJ_INFO_HEADER
{
...
typedef struct _ACPI_MEM_SPACE_CONTEXT
{
    UINT32                          Length;
    ACPI_PHYSICAL_ADDRESS           Address;
 ...
 */
typedef struct _ACPI_RESOURCE_IRQ
{
    UINT8                           Triggering;
    UINT8                           Polarity;
    UINT8                           Sharable;
...
typedef struct _ACPI_RESOURCE_DMA
{
    UINT8                           Type;
    UINT8                           BusMaster;
    UINT8                           Transfer;
...
typedef struct _ACPI_RESOURCE_START_DEPENDENT
{
...
typedef struct _ACPI_RESOURCE_IO
{
    UINT8                           IoDecode;
    UINT8                           Alignment;
    UINT8                           AddressLength;
...
typedef struct _ACPI_RESOURCE_FIXED_IO
{
    UINT16                          Address;
    UINT8                           AddressLength;
...
typedef struct _ACPI_RESOURCE_VENDOR
{
    UINT16                          ByteLength;
    UINT8                           ByteData[1];
...
typedef struct _ACPI_RESOURCE_END_TAG
{
    UINT8                           Checksum;

} ACPI_RESOURCE_END_TAG;

typedef struct _ACPI_RESOURCE_MEMORY24
{
    UINT8                           WriteProtect;
    UINT16                          Minimum;
    UINT16                          Maximum;
...
typedef struct _ACPI_RESOURCE_MEMORY32
{
    UINT8                           WriteProtect;
    UINT32                          Minimum;
    UINT32                          Maximum;
...
typedef struct _ACPI_RESOURCE_FIXED_MEMORY32
{
    UINT8                           WriteProtect;
    UINT32                          Address;
    UINT32                          AddressLength;
...
typedef struct _ACPI_MEMORY_ATTRIBUTE
{
    UINT8                           WriteProtect;
    UINT8                           Caching;
    UINT8                           RangeType;
...
typedef struct _ACPI_IO_ATTRIBUTE
{
    UINT8                           RangeType;
    UINT8                           Translation;
...
typedef union _ACPI_RESOURCE_ATTRIBUTE
{
...
typedef struct _ACPI_RESOURCE_SOURCE
{
    UINT8                           Index;
    UINT16                          StringLength;
    char                            *StringPtr;
...
typedef struct _ACPI_RESOURCE_ADDRESS
{
    ACPI_RESOURCE_ADDRESS_COMMON

} ACPI_RESOURCE_ADDRESS;

typedef struct _ACPI_RESOURCE_ADDRESS16
{
    ACPI_RESOURCE_ADDRESS_COMMON
    UINT16                          Granularity;
    UINT16                          Minimum;
...
typedef struct _ACPI_RESOURCE_ADDRESS32
{
    ACPI_RESOURCE_ADDRESS_COMMON
    UINT32                          Granularity;
    UINT32                          Minimum;
...
typedef struct _ACPI_RESOURCE_ADDRESS64
{
    ACPI_RESOURCE_ADDRESS_COMMON
    UINT64                          Granularity;
    UINT64                          Minimum;
...
typedef struct _ACPI_RESOURCE_EXTENDED_ADDRESS64
{
    ACPI_RESOURCE_ADDRESS_COMMON
    UINT8                           RevisionID;
    UINT64                          Granularity;
...
typedef struct _ACPI_RESOURCE_EXTENDED_IRQ
{
    UINT8                           ProducerConsumer;
    UINT8                           Triggering;
    UINT8                           Polarity;
...
typedef struct _ACPI_RESOURCE_GENERIC_REGISTER
{
    UINT8                           SpaceId;
    UINT8                           BitWidth;
    UINT8                           BitOffset;
...
typedef struct _ACPI_PCI_ROUTING_TABLE
{
    UINT32                          Length;
    UINT32                          Pin;
