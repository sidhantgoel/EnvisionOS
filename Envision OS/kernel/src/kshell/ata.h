...
UINT32 STDCALL AtaReadSectors(AtaDevice *Device, VIRTUAL_PTR Buffer, SIZE_T SectNum, SIZE_T Count);
UINT32 STDCALL AtaWriteSectors(AtaDevice *Device, VIRTUAL_PTR Buffer, SIZE_T SectNum, SIZE_T Count);
